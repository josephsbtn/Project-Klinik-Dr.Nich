            ...
            <div className='mt-[18px]'>
                <div className='flex-col'>
                    <div className="flex gap-[6px] mx-[25px]">
                        <a className='text-[#bdbdbd] text-xs font-nxormal font-SFPro tracking-tight'>Beranda</a>
                        <img src={arrow} alt="" />
                        <p className='text-[#bdbdbd] text-xs font-nxormal font-SFPro tracking-tight'>Galeri</p>
                    </div>
                </div>
                <div className="w-full h-full flex flex-col mt-[30px]">
                    ...
                    <section className="flex flex-col my-2 ml-[25px] w-full items-center">
                        <main className="w-full">
                            <h1 className="text-[#464646] text-base font-medium font-SFPro leading-tight tracking-tight">Layanan Populer</h1>
                        </main>
