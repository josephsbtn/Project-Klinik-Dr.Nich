                ...
                <div className="w-full h-full flex flex-col mt-[30px]">
                    ...
                    <section className="flex flex-col my-2 w-full items-center">
                        <main className="w-full flex px-6 justify-between">
                            ...
                            <a href="" className="text-right text-[#c2a353] text-xs font-medium font-['SF Pro Display'] leading-tight tracking-tight">Lihat Semua</a>
                        </main>
                                ...
                                <div className="carousel carousel-center rounded-box w-80 space-x-[10px]">
                                    <div className="carousel-item">
                                        <div className="w-[184px] h-[276px] relative">
                                            ...
                                            <div className="w-[166px] left-[10px] top-[197px] absolute text-[#bdbdbd] text-xs font-normal font-['SF Pro Display'] leading-[17px] tracking-tight">Untuk kulit berminyak dan rentang berjerawat</div>
                                            <div className="left-[10px] top-[242px] absolute text-[#c2a353] text-base font-bold font-['SF Pro Display'] leading-tight tracking-tight">Rp 110.000</div>
                                            <img className="w-[184px] h-[174px] left-0 top-0 absolute rounded-[10px] border-4 border-white" src="https://via.placeholder.com/184x174" />
                                            <div className="w-[166px] left-[10px] top-[177px] absolute text-[#464646] text-sm font-normal font-['SF Pro Display'] leading-tight tracking-tight">Facial Glow Acne</div>
                                        </div>
                                    </div>
                                    <div className="carousel-item">
                                        <div className="w-[184px] h-[276px] relative">
