        ...
        <main className="flex flex-col items-start w-[90%] lg:w-[85%] md:w-[80%] lg:mb-20 lg:flex-row lg:justify-between lg:gap-6">
          ...
          <div className="lg:flex lg:flex-col lg:items-start w-full lg:pt-6 lg:pb-1">
            <div className="flex flex-col items-start w-full mt-auto pb-1">
              <h1 className="w-[325px] text-[#c2a353] text-base font-medium font-SFPro leading-[25px] tracking-wide lg:w-full lg:text-xl">
                {nama}
              </h1>
            </div>
            ...
            <div className="flex flex-col items-start w-full pt-6 pb-1">
              <h1 className="text-[#464646] text-sm font-medium font-SFPro leading-[25px] tracking-wide lg:text-lg">
                Deskripsi Treatment
              </h1>
              <p className="text-[#464646] text-xs font-normal font-SFPro leading-[17px] tracking-wide lg:text-base whitespace-pre-line">
                {detail}
              </p>
            </div>
            ...
            <button className="w-full lg:w-fit lg:px-5 h-fit py-3 lg:py-[10px] bg-secondary text-white text-sm lg:text-base font-normal font-SFPro leading-tight tracking-wide rounded-lg mt-2 hover:shadow-[0px_4px_4px_0px_rgba(0,0,0,0.30)]  ">
