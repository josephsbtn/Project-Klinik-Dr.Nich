  ...
  return (
    <div
      ...
      <div className="flex flex-col justify-start items-start lg:mt-2 space-y-1 w-full h-24 px-2">
        ...
        <h1 className="text-gold pt-2 lg:pt-1 text-sm lg:text-base font-semibold text-secondary font-SFPro leading-wide tracking-tight">
...
export default CardPaketLayananBeranda;
