    ...
    <div className="flex bg-gradient-to-l from-[#C2A353] to-[#EAC564] flex-col w-full h-[100vh]">
      ...
      <div className="flex h-[70px] relative justify-center">
        <div className="grid z-20 absolute top-[-20] place-items-center font-bold">
          <img src={Ava} className="rounded-full  h-[100px] w-[100px]"></img>
      ...
      <div className="relative bg-white z-10 w-full h-full rounded-t-[2rem] justify-center">
        <div className="duration-300 px-10 absolute top-20  w-full h-full min-h-[400px] grid grid-cols-2 lg:grid-cols-3 items-center gap-x-0 gap-y-0 place-items-center">
          <a href="pos/user" className="h-[125px] w-[150px] ">
            <span className="bg-white h-[125px] w-[150px] border-2 border-yellow-700 rounded-2xl md:rounded-xl hover:scale-150 duration-300 flex flex-col justify-center items-center font-bold">
              <img
                src={iUser}
                color="brown"
                size={50}
          ...
          <a href="pos/produks" className="h-[125px] w-[150px] ">
            <span className="bg-white h-[125px] w-[150px] border-2 border-yellow-700 rounded-2xl md:rounded-xl hover:scale-150 duration-300 flex flex-col justify-center items-center font-bold">
              <img
                src={iProduk}
                color="brown"
          ...
          <a href="pos/laporan" className="h-[125px] w-[150px] ">
            <span className="bg-white h-[125px] w-[150px] border-2 border-yellow-700 rounded-2xl md:rounded-xl hover:scale-150 duration-300 flex flex-col justify-center items-center font-bold">
              <img
                src={iLaporan}
                color="brown"
          ...
          <a href="pos/promo" className="h-[125px] w-[150px] ">
            <span className="bg-white h-[125px] w-[150px] border-2 border-yellow-700 rounded-2xl md:rounded-xl hover:scale-150 duration-300 flex flex-col justify-center items-center font-bold">
              <img
                src={iPromo}
                color="brown"
          ...
          <a href="pos/statistik" className="h-[125px] w-[150px] ">
            <span className="bg-white h-[125px] w-[150px] border-2 border-yellow-700 rounded-2xl md:rounded-xl hover:scale-150 duration-300 flex flex-col justify-center items-center font-bold">
              <img
                src={iStat}
                color="brown"
          ...
          <a href="pos/penjualan" className="h-[125px] w-[150px] ">
            <span className="bg-white h-[125px] w-[150px] border-2 border-yellow-700 rounded-2xl md:rounded-xl hover:scale-150 duration-300 flex flex-col justify-center items-center font-bold">
              <img
                src={iPenj}
                color="brown"
