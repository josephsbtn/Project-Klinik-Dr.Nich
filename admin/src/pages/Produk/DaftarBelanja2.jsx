...
const {setNav} = useContext(navContext)
    ...
    <div className="flex flex-col px-5 py-3 gap-1 bg-white w-full h-full">
        ...
        <div className="flex justify-between gap-2 w-full pt-4 py-3">
            <a href='DetailDaftarBelanja' className="flex justify-center items-center w-[170px] gap-2 h-[40px] bg-white text-yellow-500 border border-yellow-500 font-bold rounded-xl"><img src={iTambah} alt="" /> Tambah</a>
