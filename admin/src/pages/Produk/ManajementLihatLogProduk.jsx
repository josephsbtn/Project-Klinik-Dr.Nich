...
document.title = 'Lihat Log Produk'
return (
    <div className='flex flex-col px-5 py-3 gap-1 bg-white w-full h-full pt-8'>
        ...
        <a href='' className='flex justify-between items-center text-[12px] border rounded-xl border-[#BDBDBD] px-4 py-2 mt-3 w-auto'>
        ...
        <a href='LaporanLogProduk4' className='flex justify-between items-center text-[12px] border rounded-xl border-[#BDBDBD] px-4 py-2 mt-3 w-auto'>
            <div className='flex items-center gap-3'>
                <div>
