...
return (
    <div className='flex flex-col px-5 py-8 gap-1 bg-white w-full h-full text-[#454545] text-[12px]'>
        ...
        <div className='flex justify-between items-center border border-[#EAC564] rounded-xl p-4 mt-1'>
            <p>Promo Hari Ulang Tahun</p>
            <img src={iPanKu} alt="panah kuning" />
        </div>
        <div className="text-[12px] bg-[#F6F6F6] text-[#BDBDBD] py-0.5 text-start my-4 w-full">
