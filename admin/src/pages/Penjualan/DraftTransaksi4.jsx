...
return (
    <div className='flex flex-col px-5 py-8 gap-1 bg-white w-full h-fitt pt-8 text-[#454545] text-[12px]'>
        ...
        <button className='flex justify-between items-center text-center border bg-gradient-to-r from-[#EAC564] to-[#C2A353] rounded-xl p-4 text-[14px] font-semibold text-white mt-5'>
            <p>Simpan</p>
