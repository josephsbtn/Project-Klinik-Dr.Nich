    ...
    const dummyData = [
      {
        ...
        name: "facial Series",
        deskripsi:
          "Facial series adalah rangkaian perawatan wajah yang dirancang untuk memberikan solusi komprehensif bagi berbagai kebutuhan kulit. Setiap sesi dalam facial series biasanya bertujuan untuk memperbaiki kesehatan dan penampilan kulit secara bertahap, dengan fokus pada aspek yang berbeda di setiap sesi.",
      },
      {
        id: 2,
        name: "laser DPL",
