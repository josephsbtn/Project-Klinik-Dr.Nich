    ...
    <div className='flex flex-col px-5 py-3 gap-1 bg-white w-full h-full pt-8 text-[12px] text-[#454545]'>
        <div className='items-start border border-[#C2A353] rounded-xl p-4'>
            <div className='flex justify-between'>
                <p className='text-[#E2B93B]'>Pengurangan Produk</p>
                <p className='text-[#BDBDBD]'>28 Nov 2024</p>
            </div>
            <div className='grid place-items-start my-3'>
                <p className='text-[#BDBDBD] text-[10px]'>Banyak Pengurangan Produk</p>
                <p>2</p>
            </div>
            <div className='grid place-items-start my-3'>
            ...
            <div className='grid place-items-start my-3'>
                <p className='text-[#BDBDBD] text-[10px]'>Keterangan</p>
                <p>Barang Tidak Layak Pakai</p>
            </div>
        </div>
    </div>
)
